...
export function Iniziative() {
  return (
    <section className="bg-cream-deep py-16 md:py-24">
      <div className="mx-auto grid max-w-5xl gap-12 px-4 sm:grid-cols-2 sm:items-center md:gap-16 wide:max-w-6xl">
        ...
        <div className="sm:order-1">
          <p className="eyebrow text-sky-dark wide:text-sm">Da segnare in agenda</p>
          <h2 className="font-display mt-2 text-3xl font-extrabold tracking-tight text-ink md:text-4xl wide:text-5xl">
            Iniziative
          </h2>
          <p className="mt-4 text-lg leading-relaxed text-ink-soft wide:text-xl">
            Feste, eventi e attività organizzate dal comitato durante l&apos;anno per la vita del
            quartiere.
          </p>
          <Link
            href="/news"
            className="group mt-6 inline-flex items-center gap-1.5 text-base font-bold text-brick transition-colors duration-200 hover:text-brick-dark wide:text-lg"
          >
