        ...
        <div className="grid gap-12 md:grid-cols-2">
          {[section1, section2].map((section) => (
            <div key={section.title} className="flex h-full flex-col justify-between space-y-6">
              ...
              {section.images[0] && (
                <div className="relative mt-4 aspect-[4/3] w-full overflow-hidden rounded border border-ink/5 shadow-sm">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
        ...
        <div className="mx-auto max-w-5xl wide:max-w-6xl">
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div className="order-2 md:order-1">
              {section3.images[0] && (
                <div className="relative aspect-[4/3] w-full overflow-hidden rounded border border-ink/5 shadow-sm">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
